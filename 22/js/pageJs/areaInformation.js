...
function saveAreaInformation() {
    ...
    if (areaName != null) {
        ...
        //发送请求，保存区域数据
        axios.post('http://localhost:8177/area/saveAreaInformation', data)
...
function getAreaInformation(areaId) {
    return new Promise((resolve, reject) => {
        ...
        //发送获取地区信息请求
        axios.post('http://localhost:8177/area/getArea', data)
...
function getAllArea() {
    return new Promise((resolve, reject) => {
        ...
        //发送获取地区信息请求
        axios.get('http://localhost:8177/area/getAllArea')
            .then(function (response) {
                if (response.data.code == 200) {
                    resolve(response.data.data);
                } else {
