...
function getMarkerData(markerId) {
    return new Promise((resolve, reject) => {
        ...
        axios.post('http://localhost:8177/marker/getMarker', data)
            .then(function (response) {
                if (response.data.code == 200) {
...
function saveMarkerData(markerId) {
    ...
    //发送请求
    axios.post('http://localhost:8177/marker/updateMarker', data)
    // 请求成功
    .then(function (response) {
        ...
        if (result != false) {
            ...
            geojson.eachOverlay(function (item) {
                ...
                if (gid == markerId) {
                    ...
                    //发送删除点标记请求
                    axios.get('http://localhost:8177/marker/deleteMarker', data)
                        // 请求成功
                        .then(function (response) {
